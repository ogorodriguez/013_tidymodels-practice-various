...
For our Random Forest model, the parameter we chose to tune was mtry.  Mtry 
includes a randomness in the choosing of the features to use to create the decission 
...
Then we will try to get the metrics: [accuracy, and roc_auc, explained via this link](https://medium.com/nerd-for-tech/accuracy-vs-auc-roc-a8e7a384d153).
